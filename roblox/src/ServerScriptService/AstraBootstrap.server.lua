...
local function ensureResources()
    ...
    -- Keep one deterministic P1 remote-knowledge case: Scout01 can see Wood_01,
    -- central Gatherers cannot, but Scout01 remains inside communication range.
...
print("[AstraLife] Roblox P7.5 scale test bootstrapped - 12 agents / 24 resources")
