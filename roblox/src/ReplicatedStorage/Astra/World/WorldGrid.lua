...
local function cloneDefault(x, z)
    return {
        ...
        fireIntensity = DEFAULT_CELL.fireIntensity,
        floodSeverity = DEFAULT_CELL.floodSeverity,
        droughtSeverity = DEFAULT_CELL.droughtSeverity,
        stormSeverity = DEFAULT_CELL.stormSeverity,
        hazardDanger = DEFAULT_CELL.hazardDanger,
        hazardBlocked = DEFAULT_CELL.hazardBlocked,
        dominantHazard = DEFAULT_CELL.dominantHazard,
        herbivoreCapacity = DEFAULT_CELL.herbivoreCapacity,
        predatorCapacity = DEFAULT_CELL.predatorCapacity,
        scavengerCapacity = DEFAULT_CELL.scavengerCapacity,
        herbivores = DEFAULT_CELL.herbivores,
        predators = DEFAULT_CELL.predators,
        scavengers = DEFAULT_CELL.scavengers,
        carrion = DEFAULT_CELL.carrion,
        nutrients = DEFAULT_CELL.nutrients,
        baseFertility = DEFAULT_CELL.baseFertility,
        habitatQuality = DEFAULT_CELL.habitatQuality,
        ecosystemDanger = DEFAULT_CELL.ecosystemDanger,
...
function WorldGrid:SerializeCell(cell)
    ...
    return {
        ...
        floodSeverity = cell.floodSeverity,
        droughtSeverity = cell.droughtSeverity,
        stormSeverity = cell.stormSeverity,
        hazardDanger = cell.hazardDanger,
        hazardBlocked = cell.hazardBlocked,
        dominantHazard = cell.dominantHazard,
        herbivoreCapacity = cell.herbivoreCapacity,
        predatorCapacity = cell.predatorCapacity,
        scavengerCapacity = cell.scavengerCapacity,
        herbivores = cell.herbivores,
        predators = cell.predators,
        scavengers = cell.scavengers,
        carrion = cell.carrion,
        nutrients = cell.nutrients,
        baseFertility = cell.baseFertility,
        habitatQuality = cell.habitatQuality,
        ecosystemDanger = cell.ecosystemDanger,
        danger = cell.danger,
