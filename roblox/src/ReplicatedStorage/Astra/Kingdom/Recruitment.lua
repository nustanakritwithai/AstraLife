...
function Recruitment.Update(organizationFolder, settlementFolder, laborFolder, recruitmentFolder)
    local total = organizationFolder:GetAttribute("MemberCount") or 0
    ...
    for role, ratio in pairs(TARGETS) do
        local current = organizationFolder:GetAttribute("Role_" .. role) or 0
